...
public class AmazonHomePageV1 {
    private WebDriver ldDriver;//ld:localDrıver
    public AmazonHomePageV1(WebDriver driver) {
        this.ldDriver=driver;
        PageFactory.initElements(ldDriver,this);
    }
    ...
    public void navigateToOrders(){
        Actions actions = new Actions(ldDriver);
        actions.moveToElement(accountAndList)
                .perform();

        WebDriverWait wait = new WebDriverWait(ldDriver, Duration.ofSeconds(10));
